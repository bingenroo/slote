...
git clone <slote_components_repo>

# Both set up dependencies
cd slote_app && flutter pub get
cd ../slote_components/slote_rich_text && flutter pub get
cd ../slote_viewport && flutter pub get
```
...
- Works in `slote_components/slote_rich_text/`
...
- Works in `slote_components/slote_viewport/`
...
Create a dedicated integration test app in `slote_app`:

```dart
// slote_app/lib/src/views/integration_test.dart
import 'package:slote_rich_text/slote_rich_text.dart';
import 'package:slote_viewport/slote_viewport.dart';
...
```dart
// slote_app/integration_test/app_test.dart
void main() {
...
**Scenario 1: Both modify `slote_app/pubspec.yaml`**
```yaml
...
- **Manual testing**: Regular integration testing in `slote_app`
...
2. **slote_app**: Main app where components are integrated
