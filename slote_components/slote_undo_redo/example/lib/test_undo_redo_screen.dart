...
class TestUndoRedoScreen extends StatefulWidget {
  const TestUndoRedoScreen({super.key});

  @override
  State<TestUndoRedoScreen> createState() => _TestUndoRedoScreenState();
}

class _TestUndoRedoScreenState extends State<TestUndoRedoScreen> {
  ...
  void initState() {
    ...
    // Initialize with current state after first frame
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Slote Undo/Redo Test'),
        actions: [
          IconButton(
