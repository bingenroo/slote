...
This test app allows you to test and debug the viewport/zoom/pan functionality independently without running the full Slote app. It provides a focused environment for:
